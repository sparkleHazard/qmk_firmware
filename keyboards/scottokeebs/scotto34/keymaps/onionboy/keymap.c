...
[_COLEMAKDH] = LAYOUT_split_3x5_2(
    ...
    CM_HOME_A,  CM_HOME_R,  CM_HOME_S,  CM_HOME_T,  KC_G,    KC_M,    CM_HOME_N,  CM_HOME_E,  CM_HOME_I,  CM_HOME_O,
...
[_L1] = LAYOUT_split_3x5_2(
    ...
    ESC_MOD, QUOT_MOD, NUHS_MOD, BSLS_MOD, KC_TILD, XXXXXXX, MINS_MOD, EQL_MOD, LBRC_MOD, RBRC_MOD,
    XXXXXXX, XXXXXXX,  XXXXXXX,  KC_NUBS,  KC_GRV,  XXXXXXX, KC_UNDS,  KC_PLUS, KC_LCBR,  KC_RCBR,
                                 _______,  SPACE,   KC_BSPC, L3
),
...
[_L3] = LAYOUT_split_3x5_2(
    ...
    QK_BOOT, QWERTY, COLEMAKDH, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,  XXXXXXX, XXXXXXX, GAMING,
...
[_MOUSE] = LAYOUT_split_3x5_2(
    XXXXXXX, XXXXXXX, KC_MS_U, XXXXXXX, XXXXXXX, XXXXXXX, KC_ACL0, KC_ACL1, KC_ACL2, XXXXXXX,
    XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX, XXXXXXX, KC_BTN1, KC_BTN2, KC_BTN3, XXXXXXX,
    XXXXXXX, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                               XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
...
[_GAMING] = LAYOUT_split_3x5_2(
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    XXXXXXX, XXXXXXX, XXXXXXX,
    KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    XXXXXXX, XXXXXXX, XXXXXXX,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    XXXXXXX, XXXXXXX, XXXXXXX,
                               GAMING2, KC_SPC,  XXXXXXX, XXXXXXX
),
...
[_GAMING2] = LAYOUT_split_3x5_2(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, DF(_QWERTY),
                               XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),
